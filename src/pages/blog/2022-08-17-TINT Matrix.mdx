...
This is a wifi-enabled LED matrix display project that I made as a teambuilding project for my team at work. You can connect to it over wifi and send it text, which will scroll across the display.
