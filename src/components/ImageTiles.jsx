      ...
      <div class={`${isModalOpen() ? "block" : "hidden"} fixed top-0 left-0 w-screen h-screen`}>
        <div class="w-screen h-screen backdrop-blur-md flex justify-center">
          ...
          {props.images.length <= 1
            ? <div class="grow" />
            : <button class="hidden lg:block lg:grow lg:grid place-content-center stroke-white stroke-[4px]" type="button" onClick={() => incModalImageIdx(-1)}>
        ...
        >
          <svg width="100" height="100">
            <g class="stroke-white stroke-[4px]" stroke-linecap="round">
